...
namespace PassthroughCameraSamples
{
    ...
    public class WebCamTextureManager : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            {
                PCD.DebugMessage(LogType.Warning, "PCA: Passthrough Camera functionality is not supported by the current device." +
                          $" This could be because:\n" +
                          $"1. You're running through Meta Link (expected)\n" +
                          $"2. Device doesn't support Passthrough Camera API\n" +
                          $"3. Horizon OS version is below v74\n" +
