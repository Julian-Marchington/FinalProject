...
namespace PassthroughCameraSamples.MultiObjectDetection
{
    ...
    public class DetectionManager : MonoBehaviour
    {
        ...
        [SerializeField] private bool m_showDebugInfo = true; // Show debug information
        [Space(10)]
        ...
        private IEnumerator Start()
        {
            ...
            Debug.Log("DetectionManager: Face detection + gaze analysis system is ready");
        }
        ...
        private void Update()
        {
            ...
            {
                            // Press A button to spawn 3d markers (object detection)
            ...
            // Always run face detection + gaze analysis
